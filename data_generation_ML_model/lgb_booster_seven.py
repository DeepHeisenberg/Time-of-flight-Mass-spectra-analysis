...
Ru = np.genfromtxt('Ru', delimiter=',', dtype=None)
Ru*=100
Ru = pd.DataFrame(Ru)
Ru['std'] = Ru.std(axis=1)
Ru['Class'] = 0

Mo = np.genfromtxt('Mo', delimiter=',', dtype=None)
Mo *=100
Mo = pd.DataFrame(Mo)
Mo['std'] = Mo.std(axis=1)
Mo['Class'] = 1

Sm = np.genfromtxt('Sm', delimiter=',', dtype=None)
Sm *=100
Sm = pd.DataFrame(Sm)
Sm['std'] = Sm.std(axis=1)
Sm['Class'] = 2


Nd = np.genfromtxt('Nd', delimiter=',', dtype=None)
Nd *=100
Nd = pd.DataFrame(Nd)
Nd['std'] = Nd.std(axis=1)
Nd['Class'] = 3

Gd = np.genfromtxt('Gd', delimiter=',', dtype=None)
Gd *=100
Gd = pd.DataFrame(Gd)
Gd['std'] = Gd.std(axis=1)
Gd['Class'] = 4

Yd = np.genfromtxt('Yd', delimiter=',', dtype=None)
Yd *=100
Yd = pd.DataFrame(Yd)
Yd['std'] = Yd.std(axis=1)
Yd['Class'] = 5
...
frame = [Ru, Mo, Sm, Nd, Gd, Yd, Random_class]
...
class_names = ['Ru', 'Mo', 'Sm', 'Nd', 'Gd', 'Yd','Random_class']
#
...
#
import pickle
pickle.dump(model_lgb, open("lgb_model_seven.pickle.dat", "wb"))
